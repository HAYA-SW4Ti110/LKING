...
def main_apv():
    ...
    r1=requests.get("https://github.com/GHONDA302/LKING/blob/main/Aproval.txt").text
...
\033[1;32m
 ...
 |_|  |_|_|  \_\     |_|\___|\___|_| |_|
    ...
    │ [✓] GITHUB   : Ykimg               │
    │ [✓] WHATSAPP :??         │
    │ [✓] POWER BY : \033[1;32m KIMG\033[1;37m           │
    └───────────────────────────────────────┘""")
...
class Main:
    def __init__(self):
        ...
        self.cp = []
        self.loop = 0
        os.system("xdg-open https://chat.whatsapp.com/F1fc1Ctb0ZTEfqGx54fAm0")
        print(logo)
